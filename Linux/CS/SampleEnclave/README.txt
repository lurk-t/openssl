...
add enclave.signed.so to the TLS server file (or your share dir for shared library)
use libLURK.a and all the flags for building the executable in here in OpenSSL make file
also same flages should be used for TLS server
